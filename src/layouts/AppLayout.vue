...
const menuItems = [
  ...
  { label: 'Equipamentos', icon: 'pi pi-wrench', path: '/equipamentos', command: () => router.push('/equipamentos') },
  { label: 'Equipe Técnica', icon: 'pi pi-users', path: '/signatarios', command: () => router.push('/signatarios') },
